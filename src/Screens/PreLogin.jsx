            ...
            <View style={{}}>
              {showView1 && (
                <Animated.View
                  style={{
                    borderColor: "#ffffff",
                    transform: [{ scaleX: interpolatedStretchAnimation_cash }],
                    width: 191,
                    height: 50,
                    borderRadius: 30,
                    backgroundColor: colors.YELLOW,
              ...
              <Animated.Image
                ...
                style={{
                  transform: [{ rotate: interpolatedRotateAnimation_cash }],
                  height: 50,
                  width: 50,
                  position: "absolute",
                }}
            ...
            <View style={{}}>
              {showView2 && (
                <Animated.View
                  style={{
                    borderColor: "#ffffff",
                    transform: [{ scaleX: interpolatedStretchAnimation_offer }],
                    width: 191,
                    height: 50,
                    borderRadius: 30,
                    backgroundColor: colors.YELLOW,
              ...
              <Animated.Image
                source={icon.OFFERS}
                style={{
                  transform: [{ rotate: interpolatedRotateAnimation_offer }],
                  height: 50,
                  width: 50,
                  position: "absolute",
                }}
        ...
        <View style={stylesCommon.preLoginContainerView}>
          ...
          >
            <Text
              style={[
                stylesCommon.preButtonLabelStyle,
                { textDecorationLine: "underline", color: colors.YELLOW },
              ]}
            >
              GO TO LOGIN PAGE
            </Text>
