      ...
      <View style={styles.container}>
        ...
        <QRCodeScanner
          ...
          customMarker={
            ...
            >
              <Image
                source={require("../../assets/scann_fram.png")}
          ...
          bottomContent={
            ...
            >
              <Text
                style={{ color: "#fff", fontFamily: font.GoldPlay_SemiBold }}
              >
          ...
          topContent={
            <Fontisto
              ...
              size={24}
              color={"#fff"}
              style={{ alignSelf: "flex-end", zIndex: 1, padding: 20 }}
              onPress={() => {
                navigation.goBack();
              }}
            />
