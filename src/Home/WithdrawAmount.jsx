...
export default function WithdrawAmount({ navigation }) {
  ...
  const numberformat = (x) => {
    ...
    let parts = x.toString().replace("$ ", "").replace(",", "").split(".");
    ...
    if (parts[0].length > 0) {
      return x.toString().includes(".") ? parts[0] + "." + parts[1] : parts[0];
    } else {
      return "";
    }
  };
                  ...
                  setTimeout(() => {
                    ...
                    if (amountInt >= 0 && amountInt <= 1000) {
                      if (bankverify === "1") {
                        ...
                        setAlertTitle("OPPS!");
                        setAlertMessage(
                          "Please verify your bank details for withdraw wallet balance."
                        );
                        setIconColor("red");
                        setShowAlert(true);
                      }
                      ...
                      setAlertTitle("OPPS!");
                      setAlertMessage(
                        "Please enter amount between 300 to 1000."
                      );
                      setIconColor("red");
                      setShowAlert(true);
                    }
