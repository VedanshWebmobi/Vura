  ...
  const getProfile = async () => {
    try {
      ...
      if (status === "Active") {
        ...
        const formattedAadharCardNo =
          aadharCardNo === "null" ? "" : aadharCardNo;
        ...
        const formattedCurrentCity =
          current_city === "null" ? "" : current_city;
        const formattedCurrentCountry =
          current_country === "null" ? "" : current_country;
        const formattedCurrentPincode =
          current_pincode === "null" ? "" : current_pincode;
        const formattedCurrentState =
          current_state === "null" ? "" : current_state;
        const formattedCurrentStreet =
              ...
              <Image
                source={
                  focused
                    ...
                    : require("../../assets/home_icon_white.png")
                }
            ...
            tabBarIcon: ({ focused, color, size }) => {
              ...
              return (
                <Image
                  source={
                    focused
                      ? require("../../assets/ticket_discount_select.png")
                      : require("../../assets/ticket_discount.png")
                  }
                  style={{ height: 20, width: 20, resizeMode: "contain" }}
                />
              );
